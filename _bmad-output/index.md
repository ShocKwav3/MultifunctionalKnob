...
- **Input:** Rotary encoder with button, 4 configurable buttons
- **RTOS:** FreeRTOS (built-in)
- **Features:** Menu system, power management, Bluetooth pairing
...
1. **Scroll Mode** - Mouse wheel emulation (vertical scrolling)
2. **Volume Mode** - Media volume control
3. **Zoom Mode** - Ctrl+scroll for zoom in/out

Mode selection and wheel direction are configurable via the on-device menu (long press to activate).
...
| 2.0.0 | 2026-01-22 | Updated for Sprint 1 completion (Epics 6-10 implemented) |

---

**Note:** This documentation was automatically generated by the BMAD Document Project workflow and updated after Sprint 1 completion. For questions or issues with the documentation, refer to the development guide or project maintainers.

---

*Documentation index last updated 2026-01-22. This is the primary entry point for AI-assisted development and project navigation.*