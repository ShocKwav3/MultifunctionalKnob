...
- [Architecture: Factory Reset Trigger](_bmad-output/architecture/index.md#factory-reset-trigger)
- [Epics: Story 1.4](_bmad-output/epics/index.md#story-14-implement-boot-configuration-restore-and-factory-reset)
